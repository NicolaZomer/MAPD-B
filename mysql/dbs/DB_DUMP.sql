...
--
-- Table structure for table `Users_py1`
--

DROP TABLE IF EXISTS `Users_py1`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `Users_py1` (
  `UserID` varchar(30) DEFAULT NULL,
  `BadgeNum` int DEFAULT NULL,
  `FirstName` varchar(255) DEFAULT NULL,
  `LastName` varchar(255) DEFAULT NULL,
  `Age` int DEFAULT NULL,
  `OtherAttr` float DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `Users_py1`
--

LOCK TABLES `Users_py1` WRITE;
/*!40000 ALTER TABLE `Users_py1` DISABLE KEYS */;
/*!40000 ALTER TABLE `Users_py1` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `products` VALUES (1,'Founders Porter',4.9,12,0),(2,'Punk IPA',5.2,45,0),(3,'HB Dunker',4.5,250,0),(4,'Forst Xmax',8,2,1),(5,'Damm Complot',3.7,120,0);
...
-- Dump completed on 2022-04-03 17:41:37
